...
exports.listarTasks = async (req, res) => {
    ...
    try {
        ...
        return res.status(200).json({message: 'Tarefas ecnontradas com sucesso', data: task})
...
exports.atualizartasks = async (req, res) => {
    ...
    try {
        ...
        const { id } = req.params // id da task
        ...
        if (!task) {
            return res.status(404).json({ error: 'Tarefa não encontrada'}) //pensar em uma mensagem para colocar aqui
        }
